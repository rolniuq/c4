...
| --- | --- | --- | --- | --- |
| `leader` | 🧠 Leader — breaks goals into tasks, reviews results | opencode | opencode (minimax-m2.5-free) | 2026-03-06 |
| `dev-1` | 💻 Dev-1 — Backend specialist (APIs, auth, DB) | opencode | opencode (minimax-m2.5-free) | 2026-03-06 |
| `dev-2` | 🎨 Dev-2 — Frontend specialist (UI, components) | opencode | opencode (minimax-m2.5-free) | 2026-03-06 |
| `dev-3` | 🔧 Dev-3 — DevOps/Test specialist (CI, testing) | opencode | opencode (minimax-m2.5-free) | 2026-03-06 |
